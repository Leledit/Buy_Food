...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>Buy Food | Coming Soon</title>
				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-8 col-md-offset-2">
							...
							<!-- logo -->
							<div class="logo">
								<a href="index.php"><img src="images/logola.png" alt="iDea" name="logo" width="150" height="150"  id="logo"></a>
			        </div>
							...
							<h1 class="title text-center">Estamos Chegando</h1>
							
							<p class="text-center">A Plataforma Buy Food está nos retoques finais! Aguarde estaremos disponiveis em breve...</p>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12 text-center">
							<br>
							<p align="center" >Copyright © 2017 by   Buy Food. All Rights Reserved</p>
						</div>
