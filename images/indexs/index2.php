					...
					<div class="slider-banner-container">
						<div class="slider-banner-3">
							<ul>
								...
								<!-- main image -->
								<img src="images/6.jpg"  alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								<!-- main image -->
								<img src="images/7.jpg"  alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								<div class="tp-caption tp-resizeme sfb"
									...
									data-start="600"
									data-end="10000"
									data-endspeed="600"><a href="Mococa.php" class="btn btn-white btn-lg">Pedir <i class="fa fa-angle-right pl-10"></i></a>
								</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="box-style-1 object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="0">
                                                ...
                                                <a href="https://www.facebook.com/buyfoodbr/"  class="btn btn-success">Acessar</a>
										...
										<div class="col-sm-4">
											<div class="box-style-1 object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="200">
												...
												<h2>Localização</h2>
												<p>"Buy Food  chegou a Mococa-SP! em breve em mais cidades... Click and Buy Food."</p>
												<a href="page-about.php" class="btn btn-success">Sobre</a>
											</div>
										</div>
										<div class="col-sm-4">
											<div class="box-style-1 object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="400">
												...
												<a href="Cadastre-se.php" class="btn btn-success">Cadastrar-se</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="text-center">
										<a href="Areado.php" class="btn btn btn-success">Pedir</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12">
							...
							<div class="owl-carousel carousel">
									...
									<div class="overlay-container">
										...
										<div class="overlay">
											<div class="overlay-links">
												...
												<a href="images/7.jpg" class="popup-img"><i class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
									<div class="image-box-body">
										<h3 class="title"><a href="page-404.php">Estabelecimento</a></h3>
                                          <p>1º Lugar</p>
										<a href="page-404.php" class="link"><span>Ver Cardápio</span></a>
									</div>
								</div>
								...
								<div class="image-box object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="100">
									...
									<div class="image-box-body">
										<h3 class="title"><a href="cardapioedmir.php">Estabelecimento</a></h3>
										<p>3º Lugar</p>
										<a href="page-404.php" class="link"><span>Ver Cardápio</span></a>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-8 col-md-offset-2">
									...
									<div class="testimonial-body">
										...
										<div class="testimonial-info-2">CEO e COF Buy Food</div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-8 col-md-offset-2">
									...
									<div class="testimonial-image">
										<img src="images/leandro.png" alt="leandro" title="leandro" class="img-circle">
									</div>
									<div class="testimonial-body">
										...
										<div class="testimonial-info-1">Leandro Caixeta</div>
										<div class="testimonial-info-2">COF Buy Food</div>
									</div>
								</div>
							</div>
						</div>
